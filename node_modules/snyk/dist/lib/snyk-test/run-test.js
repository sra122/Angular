...
function assembleLocalPayload(root, options, policyLocations) {
    return __awaiter(this, void 0, void 0, function () {
        var plugin, moduleInfo, analysisType, spinnerLbl, inspectRes, pkg, gemfileLockBase64, gemfileLockContents, depGraph, policy, err_1, dockerInfo, payload;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 7:
                    ...
                    return [3 /*break*/, 8];
                case 8:
                    dockerInfo = createDockerInfo(pkg);
                    payload = {
                        method: 'POST',
